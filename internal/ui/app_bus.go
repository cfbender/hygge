...
func (a *App) bridge() {
	...
	subLazyContext := bus.Subscribe[bus.LazyContextLoaded](a.opts.Bus, bus.SubscribeOptions{BufferSize: 16})
	...
	go forward(subLazyContext.C(), a.busCh, stop, subLazyContext.Unsubscribe)
