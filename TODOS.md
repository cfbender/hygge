...
- [ ] **Phase 4 — Coordinator cleanup** — Extract `internal/coordinator`; adapt `internal/subagent/runtime.go` impl; retire legacy provider stream adapters once all tests and non-turn command seams have Fantasy fakes.
