...
- [ ] **Phase 6 — UI** — Theme/model-select/API-key dialogs; slash command system update.
  ...
  - [ ] **Phase 6E+ follow-ups** — API-key/model/theme dialogs on the overlay stack; richer command dialogs; durable todo persistence/hydration; richer attachment previews/removal shortcuts; optional backdrop rendering over preserved app content instead of full-screen modal replacement.
